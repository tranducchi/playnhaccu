...
<div class="box box-primary">
    ...
    <br />
    <!-- form start -->
    <form role="form" method="post" enctype="multipart/form-data" action="/admin/article">
      @csrf
    <input type="hidden" name="user_id" value="{{Auth::user()->id}}">
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <textarea name="description" id="" cols="30" rows="3" class="form-control" placeholder="Nhập mô tả cho chuyên mục"></textarea>
        </div>
        <div class="form-group">
          ...
          <div class="col-lg-6">
              <div class="form-group">
                  ...
                  <div class="form-inline">
                      <input type="text" id="tags" class="form-control" value="" placeholder="Tag bài viết" data-role="tagsinput" name="tags">
      ...
      <div class="box-footer">
        <button type="submit" class="btn btn-primary"><i class="fa fa-pencil"></i>  Thêm mới</button>
      </div>
    </form>
  </div>
  {{-- Add CkEditor --}}
